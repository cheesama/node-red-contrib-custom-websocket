// copy from
// https://github.com/node-red/node-red/blob/bccfd21cf46da7dfdde9653466f218fb3459ad7d/packages/node_modules/%40node-red/nodes/core/network/22-websocket.js
...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("custom-websocket-listener",WebSocketListenerNode);
    RED.nodes.registerType("custom-websocket-client",WebSocketListenerNode);
    ...
    RED.nodes.registerType("custom-websocket-in",WebSocketInNode);
    ...
    RED.nodes.registerType("custom-websocket-out",WebSocketOutNode);
}
